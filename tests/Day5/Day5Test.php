...
final class Day5Test extends TestCase
{
    ...
    {
        // Act & Assert
        $this->assertSame(143, new Day5(withExampleData: true)->firstPart());
    }

    public function testItSolvesPart1(): void
    {
        // Act & Assert
        $this->assertSame(6498, new Day5()->firstPart());
    }

    public function testItSolvesTheExamplePart2(): void
    {
        // Act & Assert
        $this->assertSame(123, new Day5(withExampleData: true)->secondPart());
    }

    public function testItSolvesPart2(): void
    {
        // Act & Assert
        $this->assertSame(5017, new Day5()->secondPart());
    }
}
